        ...
        <main className="min-h-screen bg-bg text-text-primary flex flex-col md:flex-row overflow-hidden">
            ...
            <div className="w-full md:w-[40%] bg-card border-r-4 border-text-primary flex flex-col h-[50vh] md:h-screen overflow-y-auto">
                ...
                <div className="p-6 md:p-8 space-y-8 flex-1">
                    ...
                    <div>
                        ...
                        <button className="w-full bg-bg border-4 border-text-primary py-3 font-mono text-xs font-bold uppercase hover:bg-text-primary hover:text-black flex justify-center items-center gap-2">
                    ...
                    <div>
                        <div className="flex justify-between items-end mb-4">
                            ...
                            <button className="bg-text-primary text-black px-2 py-1 flex justify-center items-center gap-1 font-mono text-[10px] uppercase font-bold border-2 border-text-primary hover:bg-accent hover:border-accent">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4">
                                <select className="flex-1 bg-card border-4 border-text-primary px-4 py-2 font-mono text-sm uppercase text-white outline-none cursor-pointer">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    className="w-full bg-bg border-4 border-text-primary p-3 pl-10 font-display text-xl uppercase focus:border-accent focus:outline-none placeholder-text-secondary text-white"
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <button className="w-12 h-12 flex items-center justify-center bg-bg border-2 border-text-primary text-text-secondary hover:text-white border-dashed">
                                <Plus size={20} />
                            </button>
                        </div>
                    </div>
            ...
            <div className="w-full md:w-[60%] flex flex-col h-[50vh] md:h-screen bg-bg relative">
                <div className="flex-1 p-8 flex justify-center items-center relative overflow-hidden">
                    ...
                    {/* Live Canvas Mockup */}
                    <div className={`w-full max-w-lg aspect-square ${activeTemplate.bg} border-8 border-text-primary flex flex-col justify-between items-center p-8 text-center relative shadow-[16px_16px_0_0_#FFF]`}>

                        <h2 className={`font-display text-5xl md:text-7xl uppercase leading-none drop-shadow-[0_4px_4px_rgba(0,0,0,1)] ${activeTemplate.bg === 'bg-bg' ? 'text-white' : 'text-white'}`}>
                            {topText || "TOP TEXT"}
                        </h2>
                        ...
                        <h2 className={`font-display text-5xl md:text-7xl uppercase leading-none drop-shadow-[0_4px_4px_rgba(0,0,0,1)] z-10 ${activeTemplate.bg === 'bg-bg' ? 'text-white' : 'text-white'}`}>
                            {bottomText || "BOTTOM TEXT"}
                        </h2>

                        <div className="absolute bottom-2 right-4 font-mono text-[10px] font-bold text-white/50 uppercase tracking-widest bg-black px-1">
                ...
                <div className="bg-card border-t-4 border-text-primary p-4 z-10 flex flex-wrap gap-4">
                    ...
                    <div className="flex gap-4 min-w-max">
                        <button className="bg-success text-black font-mono font-bold text-sm uppercase px-6 py-4 border-4 border-black hover:bg-white flex justify-center items-center gap-2 shadow-[4px_4px_0_0_#000]">
