...
export default function NewsAggregatorPage() {
    ...
    const newsItems = [
        { source: "ThePrint", title: "Over 3.5 Lakh Unemployed Youth Join Cockroach Janta Party", time: "2h ago", readTime: "30s", summary: "The newly formed party hits 3.5L members via google form after CJI remark.", img: "https://images.unsplash.com/photo-1591115765373-5207764f72e7?w=800&q=80&auto=format&fit=crop", url: "https://theprint.in/tag/unemployment/" },
        ...
        { source: "The Wire", title: "Mahua Moitra officially verified as CJP member", time: "1d ago", readTime: "1m", summary: "TMC MP embraces the 'Main Bhi Cockroach' movement publicly on X.", img: "https://images.unsplash.com/photo-1495020689067-958852a7765e?w=800&q=80&auto=format&fit=crop", url: "https://thewire.in/tag/mahua-moitra" },
        ...
        { source: "Wikipedia", title: "Background: Youth Unemployment in India (data explainer)", time: "2d ago", readTime: "5m", summary: "Comprehensive explainer covering the structural drivers, definitions, and current numbers.", img: "https://images.unsplash.com/photo-1531206715517-5c0ba140b2b8?w=800&q=80&auto=format&fit=crop", url: "https://en.wikipedia.org/wiki/Unemployment_in_India" },
    ];
