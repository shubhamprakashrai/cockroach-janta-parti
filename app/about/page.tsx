...
export default function AboutPage() {
    return (
        <main className="min-h-screen bg-bg text-text-primary pb-24">
            ...
            {/* Hero Notice */}
            <header className="px-4 py-16 md:py-24 border-b-8 border-text-primary bg-alert text-white text-center relative shadow-[0_16px_0_0_rgba(255,214,10,1)]">
            ...
            <section className="max-w-[1200px] mx-auto px-4 py-20 grid lg:grid-cols-2 gap-16">
                ...
                <div className="space-y-12">
                    <div className="bg-card border-4 border-text-primary p-8 shadow-[8px_8px_0_0_#000]">
                        <h2 className="font-display text-4xl uppercase text-rich-black mb-6 border-b-4 border-text-primary pb-2">Who We Are</h2>
                    ...
                    <div className="bg-card border-4 border-text-primary p-8 shadow-[8px_8px_0_0_#000]">
                        <h2 className="font-display text-4xl uppercase text-rich-black mb-6 border-b-4 border-text-primary pb-2">Why This Exists</h2>
                        <p className="font-hindi text-lg text-text-secondary leading-relaxed font-bold">
                ...
                <div className="space-y-8">
                    ...
                    <form className="bg-black border-4 border-text-primary p-8 space-y-6" onSubmit={e => e.preventDefault()}>
                        <div>
                            ...
                            <input type="text" className="w-full bg-bg border-4 border-text-primary p-4 font-mono uppercase text-rich-black focus:outline-none focus:border-accent" />
                        </div>
                        <div>
                            <label className="font-mono uppercase font-bold text-xs block mb-2 text-text-secondary">Transmission (Message)</label>
                            <textarea rows={4} className="w-full bg-bg border-4 border-text-primary p-4 font-mono uppercase text-rich-black focus:outline-none focus:border-accent resize-none"></textarea>
                        </div>
                        <button className="w-full bg-accent text-black font-display text-3xl uppercase py-4 border-4 border-black hover:bg-white hover:-translate-y-1 shadow-[4px_4px_0_0_#000] transition-all">
                            SEND SIGNAL
                        </button>
                    </form>

                    <div className="flex flex-col gap-4">
                        <a href="#" className="bg-bg border-4 border-text-primary p-4 font-mono font-bold uppercase flex items-center justify-between hover:bg-text-primary hover:text-bg transition-colors group">
