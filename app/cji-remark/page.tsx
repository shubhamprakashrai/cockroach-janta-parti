    ...
    return (
        <main className="min-h-screen bg-bg text-text-primary pb-24 border-x-[16px] border-alert">
            ...
            <section className="max-w-5xl mx-auto px-4 py-16">
                ...
                {/* Full Quote Callout */}
                <div className="bg-alert text-white p-8 md:p-12 border-8 border-black shadow-[16px_16px_0_0_#000] rotate-1 hover:rotate-0 transition-transform mb-20 relative">
                ...
                <div className="grid md:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="space-y-8">
                        <h2 className="font-display text-5xl uppercase text-rich-black border-b-4 border-text-primary pb-4">Why This Broke India</h2>
                        ...
                        <div className="space-y-6 font-hindi text-lg md:text-xl text-text-secondary leading-relaxed">
                            ...
                            <p className="p-4 bg-card border-l-4 border-accent text-rich-black">
                        ...
                        <Link href="/manifesto" className="inline-flex bg-white text-black font-display text-2xl uppercase py-4 px-8 border-4 border-black hover:bg-accent hover:-translate-y-1 shadow-[8px_8px_0_0_#000] transition-all items-center gap-3">
                            ...
                            {reactions.map((r, i) => (
                                <div key={i} className="bg-bg border-2 border-text-primary p-4 hover:border-accent transition-colors">
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="font-mono text-sm uppercase font-bold text-rich-black tracking-widest">{r.handle}</span>
